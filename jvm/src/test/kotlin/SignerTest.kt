...
class SignerTest {
    ...
    @Test
    fun signWithCert() {
        assertEquals(expectedSignature, signContent(password, certificate, content))
    }

    @Test
    fun signWithKey() {
        assertEquals(expectedSignature, signContent(privateKey, content))
    }

    @Test
    fun getPrivateKeyFromCert() {
        assertEquals(privateKey, getPrivateKeyFromCert(password, certificate))
    }
}
